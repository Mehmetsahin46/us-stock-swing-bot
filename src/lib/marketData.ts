...
export const BIST_UNIVERSE: UniverseItem[] = [
  ...
  // Sağlık & İlaç
  { ticker: 'MPARK.IS', displayTicker: 'MPARK', name: 'MLP Sağlık (Medical Park)', sector: 'Healthcare', market: 'BIST', currency: 'TRY' },
  { ticker: 'GENIL.IS', displayTicker: 'GENIL', name: 'Gen İlaç', sector: 'Healthcare', market: 'BIST', currency: 'TRY' },
  { ticker: 'ECILC.IS', displayTicker: 'ECILC', name: 'Eczacıbaşı İlaç', sector: 'Healthcare', market: 'BIST', currency: 'TRY' },
  { ticker: 'DEVA.IS', displayTicker: 'DEVA', name: 'Deva Holding', sector: 'Healthcare', market: 'BIST', currency: 'TRY' },
...
export const US_UNIVERSE: UniverseItem[] = [
  ...
  { ticker: 'LLY', displayTicker: 'LLY', name: 'Eli Lilly and Company', sector: 'Healthcare', market: 'US', currency: 'USD' },
  { ticker: 'UNH', displayTicker: 'UNH', name: 'UnitedHealth Group', sector: 'Healthcare', market: 'US', currency: 'USD' },
  { ticker: 'JNJ', displayTicker: 'JNJ', name: 'Johnson & Johnson', sector: 'Healthcare', market: 'US', currency: 'USD' },
  { ticker: 'ABBV', displayTicker: 'ABBV', name: 'AbbVie Inc.', sector: 'Healthcare', market: 'US', currency: 'USD' },
  { ticker: 'MRK', displayTicker: 'MRK', name: 'Merck & Co., Inc.', sector: 'Healthcare', market: 'US', currency: 'USD' },
  { ticker: 'PFE', displayTicker: 'PFE', name: 'Pfizer Inc.', sector: 'Healthcare', market: 'US', currency: 'USD' },
  { ticker: 'AMGN', displayTicker: 'AMGN', name: 'Amgen Inc.', sector: 'Healthcare', market: 'US', currency: 'USD' },
  { ticker: 'TMO', displayTicker: 'TMO', name: 'Thermo Fisher Scientific', sector: 'Healthcare', market: 'US', currency: 'USD' },
  { ticker: 'ABT', displayTicker: 'ABT', name: 'Abbott Laboratories', sector: 'Healthcare', market: 'US', currency: 'USD' },
  { ticker: 'DHR', displayTicker: 'DHR', name: 'Danaher Corporation', sector: 'Healthcare', market: 'US', currency: 'USD' },
  { ticker: 'BMY', displayTicker: 'BMY', name: 'Bristol-Myers Squibb', sector: 'Healthcare', market: 'US', currency: 'USD' },
  { ticker: 'ISRG', displayTicker: 'ISRG', name: 'Intuitive Surgical', sector: 'Healthcare', market: 'US', currency: 'USD' },
  { ticker: 'GILD', displayTicker: 'GILD', name: 'Gilead Sciences', sector: 'Healthcare', market: 'US', currency: 'USD' },
  { ticker: 'VRTX', displayTicker: 'VRTX', name: 'Vertex Pharmaceuticals', sector: 'Healthcare', market: 'US', currency: 'USD' },
  { ticker: 'REGN', displayTicker: 'REGN', name: 'Regeneron Pharmaceuticals', sector: 'Healthcare', market: 'US', currency: 'USD' },
  { ticker: 'MDT', displayTicker: 'MDT', name: 'Medtronic plc', sector: 'Healthcare', market: 'US', currency: 'USD' },
  { ticker: 'SYK', displayTicker: 'SYK', name: 'Stryker Corporation', sector: 'Healthcare', market: 'US', currency: 'USD' },
  { ticker: 'ELV', displayTicker: 'ELV', name: 'Elevance Health', sector: 'Healthcare', market: 'US', currency: 'USD' },
  { ticker: 'CI', displayTicker: 'CI', name: 'The Cigna Group', sector: 'Healthcare', market: 'US', currency: 'USD' },
  { ticker: 'CVS', displayTicker: 'CVS', name: 'CVS Health Corporation', sector: 'Healthcare', market: 'US', currency: 'USD' },
  { ticker: 'HUM', displayTicker: 'HUM', name: 'Humana Inc.', sector: 'Healthcare', market: 'US', currency: 'USD' },
  { ticker: 'BDX', displayTicker: 'BDX', name: 'Becton, Dickinson and Co.', sector: 'Healthcare', market: 'US', currency: 'USD' },
  { ticker: 'BSX', displayTicker: 'BSX', name: 'Boston Scientific Corp.', sector: 'Healthcare', market: 'US', currency: 'USD' },
  { ticker: 'ZTS', displayTicker: 'ZTS', name: 'Zoetis Inc.', sector: 'Healthcare', market: 'US', currency: 'USD' },
  { ticker: 'MCK', displayTicker: 'MCK', name: 'McKesson Corporation', sector: 'Healthcare', market: 'US', currency: 'USD' },
  { ticker: 'COR', displayTicker: 'COR', name: 'Cencora, Inc.', sector: 'Healthcare', market: 'US', currency: 'USD' },
  { ticker: 'CAH', displayTicker: 'CAH', name: 'Cardinal Health, Inc.', sector: 'Healthcare', market: 'US', currency: 'USD' },
  { ticker: 'EW', displayTicker: 'EW', name: 'Edwards Lifesciences', sector: 'Healthcare', market: 'US', currency: 'USD' },
  { ticker: 'DXCM', displayTicker: 'DXCM', name: 'DexCom, Inc.', sector: 'Healthcare', market: 'US', currency: 'USD' },
  { ticker: 'IDXX', displayTicker: 'IDXX', name: 'IDEXX Laboratories', sector: 'Healthcare', market: 'US', currency: 'USD' },
  { ticker: 'HIMS', displayTicker: 'HIMS', name: 'Hims & Hers Health', sector: 'Healthcare', market: 'US', currency: 'USD' },
  { ticker: 'MRNA', displayTicker: 'MRNA', name: 'Moderna, Inc.', sector: 'Healthcare', market: 'US', currency: 'USD' },
  { ticker: 'BIIB', displayTicker: 'BIIB', name: 'Biogen Inc.', sector: 'Healthcare', market: 'US', currency: 'USD' },
  ...
  // 11. Additional S&P 500 & Mid-Cap Liquid Leaders (Balanced Sectors)
  ...
  { ticker: 'ALGN', displayTicker: 'ALGN', name: 'Align Technology, Inc.', sector: 'Healthcare', market: 'US', currency: 'USD' },
  { ticker: 'PODD', displayTicker: 'PODD', name: 'Insulet Corporation', sector: 'Healthcare', market: 'US', currency: 'USD' },
  { ticker: 'RMD', displayTicker: 'RMD', name: 'ResMed Inc.', sector: 'Healthcare', market: 'US', currency: 'USD' },
  { ticker: 'HOLX', displayTicker: 'HOLX', name: 'Hologic, Inc.', sector: 'Healthcare', market: 'US', currency: 'USD' },
  { ticker: 'COO', displayTicker: 'COO', name: 'The Cooper Companies', sector: 'Healthcare', market: 'US', currency: 'USD' },
  { ticker: 'TECH', displayTicker: 'TECH', name: 'Bio-Techne Corporation', sector: 'Healthcare', market: 'US', currency: 'USD' },
  { ticker: 'WST', displayTicker: 'WST', name: 'West Pharmaceutical Services', sector: 'Healthcare', market: 'US', currency: 'USD' },
  { ticker: 'IQV', displayTicker: 'IQV', name: 'IQVIA Holdings Inc.', sector: 'Healthcare', market: 'US', currency: 'USD' },
  { ticker: 'MEDP', displayTicker: 'MEDP', name: 'Medpace Holdings, Inc.', sector: 'Healthcare', market: 'US', currency: 'USD' },
  { ticker: 'EXAS', displayTicker: 'EXAS', name: 'Exact Sciences Corporation', sector: 'Healthcare', market: 'US', currency: 'USD' },
  { ticker: 'NTRA', displayTicker: 'NTRA', name: 'Natera, Inc.', sector: 'Healthcare', market: 'US', currency: 'USD' },
